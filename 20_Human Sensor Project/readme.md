...
* ~Design Notebook:~ Based on your design, what are some things you’d like to keep in mind while crafting your Human Sensor Project? (5 min)
...
* ~Design Notebook:~ Write down/diagram some tips for crafting projects that use aluminum foil sensors. (5 min)
...
* ~Design Notebook~: Reflecting on your project, how did it turn out compared to your original plan? What changed? (5 min)
