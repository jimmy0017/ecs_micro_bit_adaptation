...
# Maybe there should be a "LightingPqattern2" function here?
...
while True:
    ...
    #Serial.println(foilStorage); //prints the value of the sensor to the serial monitor
    ...
    # you want to call
    if (foilStorage > 1000): #Set your first condition. 
        # For instance, this might be for when nothing is touching.
        LightingPattern1 () # here is your first lighting pattern (change name as needed)
    elif (foilStorage >= 970  and foilStorage <= 1000):
        LightingPattern2 () # second lighting pattern...
    else: # this would be for everything below the last condition
        LightingPattern3 ()
